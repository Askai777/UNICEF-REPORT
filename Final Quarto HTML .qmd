...
The lack of resources and weak economic situation are the major causes behind the dire result of multutrition cases in these countries. 
...
A scatter plot would be the best way to visualize the results.
If there is a positive correlation between Population,Life-expectancy  and malnutrition, it suggests that economic growth alone may not be enough to address malnutrition, and that other interventions may be needed
